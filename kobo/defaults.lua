...
KOBO_SCREEN_SAVER = "/mnt/onboard/.data/schedule.png"  -- image or directory with pictures or "-"
KOBO_SCREEN_SAVER_LAST_BOOK = false -- get screensaver from last book if possible
